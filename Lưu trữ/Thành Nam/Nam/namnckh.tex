...
\centering
 ...
 Trong thực tế,ở một số mô hình Bài toán Quy hoạch tuyến tính, 
 các hệ số ban đầu như
  ...
  có thể không xác định một cách chính xác mà có thể dao động,
   biến đổi phụ thuộc vào một hay nhiều tham số như thời gian,\ bão lụt,\ tắc đường,\ nguyên liệu v.v\ldots



\subsection{PHƯƠNG PHÁP ĐƠN HÌNH GIẢI BÀI TOÁN 
QUY HOẠCH TUYẾN TÍNH THAM SỐ Ở HÀM MỤC TIÊU}
\subsection{Tối ưu tuyến tính chứa tham số vế phải ràng buộc}
